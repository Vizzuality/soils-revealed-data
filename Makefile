...
up:
	$(DOCKER_CMD) build && $(DOCKER_CMD) up

## Get inside the Docker container
inside:
	$(DOCKER_CMD) build && $(DOCKER_CMD) up -d && $(DOCKER_CMD) exec soils_revealed-notebooks bash
...
init-git:
	git init && git remote add origin git@github.com:Vizzuality/project
...
lint:
	black soils_revealed && flake8 soils_revealed
